...
impl BlgMoireModel {
    pub fn new(w: f64, hbar_v: f64, u: f64, t: Array2<Complex64>) -> BlgMoireModel {
        BlgMoireModel { w, hbar_v, u, t, sigma: pauli_matrices() }
    }
    ...
    pub fn hk_lat(&self, k_lat: &[f64; 3]) -> Array2<Complex64> {
        ...
        hk.slice_mut(s![2..4, 0..2]).assign(&(self.t.t().map(|x| x.conj())));
...
pub fn pauli_matrices() -> Vec<Array2<Complex64>> {
    let sigma_x = arr2(&[[Complex64::new(0.0, 0.0), Complex64::new(1.0, 0.0)],
                         [Complex64::new(1.0, 0.0), Complex64::new(0.0, 0.0)]]);
    let sigma_y = arr2(&[[Complex64::new(0.0, 0.0), Complex64::new(0.0, -1.0)],
                         [Complex64::new(0.0, 1.0), Complex64::new(0.0, 0.0)]]);
    let sigma_z = arr2(&[[Complex64::new(1.0, 0.0), Complex64::new(0.0, 0.0)],
